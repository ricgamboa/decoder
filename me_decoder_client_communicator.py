# This module must be replaced with communication between the local decoder server and the client,
...
class ClientCommunicator():
    ...
    def receive_request_info(self):
        ...
        for ic_li in received_info["question_info"]["icons_lists_all"]:
            self.question.append_icon_set(ic_li["icon_list"])
        for pos_li in received_info["question_info"]["positions_lists_all"]:
